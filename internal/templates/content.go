...
@tailwind utilities;`
	...
	TailwindConfigVanilla = `/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    "./**/*.py",    
  ],
  ...
  plugins: [],
	...
	TailwindConfigDaisy = `/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    "./**/*.py",    
  ],
  ...
  plugins: [require("@tailwindcss/typography"), require("daisyui")],
	...
	MainPYVanilla = `from fasthtml.common import *
...
serve()`
	...
	MainPYDaisy = `from fasthtml.common import *
